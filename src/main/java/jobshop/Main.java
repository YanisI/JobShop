...
public class Main {
    ...
    static {
        ...
        solvers.put("SPT",new GreedySolver());
        solvers.put("LRPT",new GreedySolverLRPT());
        solvers.put("ESTSPT",new GreedySolverEstSPT());
        solvers.put("ESTLRPT",new GreedySolverEstLRPT());

        solvers.put("D",new DescentSolver());
        solvers.put("T",new TabooSolver());
